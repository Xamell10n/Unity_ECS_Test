...
public partial class InputContext {
    ...
    public Enemies.Components.Input.DeltaTimeComponent deltaTime { get { return deltaTimeEntity.deltaTime; } }
    public bool hasDeltaTime { get { return deltaTimeEntity != null; } }

    public InputEntity SetDeltaTime(float newValue) {
        if (hasDeltaTime) {
            throw new Entitas.EntitasException("Could not set DeltaTime!\n" + this + " already has an entity with Enemies.Components.Input.DeltaTimeComponent!",
...
public partial class InputEntity {
    ...
    public Enemies.Components.Input.DeltaTimeComponent deltaTime { get { return (Enemies.Components.Input.DeltaTimeComponent)GetComponent(InputComponentsLookup.DeltaTime); } }
    ...
    public void AddDeltaTime(float newValue) {
        ...
        var component = (Enemies.Components.Input.DeltaTimeComponent)CreateComponent(index, typeof(Enemies.Components.Input.DeltaTimeComponent));
